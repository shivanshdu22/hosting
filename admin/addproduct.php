            ...
            <table id="categorytable" class="table table-borderless table-hover">
                ...
                <?php
						...
						<tr>
                            ...
                            <td><?php if($udd['prod_parent_id']==1){echo "Hosting";} else{echo "Unknow Category";}?></td>
                            <td><?php echo $udd['prod_name'];?></td>
                            <td><?php echo $udd['link'];?></td>
                            <td><?php if($udd['prod_available']==1){echo "Available";} else{echo "Unavailable";}?></td>
                            <td><?php echo $udd['prod_launch_date'];?></td>   
                            <td>
								<!-- Icons -->
								<a href="#" data-id="<?php echo $udd['prod_name'];?>" class="edit btn btn-info"  title="Edit">Edit</a>
								<a href="#" data-id="<?php echo $udd['prod_name'];?>" class="delete btn btn-danger"  title="Delete">Delete</a> 
							</td>                       
						</tr>
				<?php }?>
                </tbody>
            ...
            $('.delete').click(function(){
                    if(confirm("Are you sure you want to delete this?")){ 
                        ...
                        $.ajax({
                            url:'ajax.php',
                            type:'POST',
                            data:{ cat_id:categoryid , action:action},
